...
import com.websarva.wings.android.navigationsamplesafekotlin.databinding.FragmentMemoListBinding
import com.websarva.wings.android.navigationsamplesafekotlin.databinding.MemoListItemBinding
import com.websarva.wings.android.navigationsamplesafekotlin.ui.MemoListViewModel
...
class MemoListFragment : Fragment() {
	...
	private inner class OnListItemClickListener : View.OnClickListener {
		override fun onClick(view: View) {
			...
			val action = MemoListFragmentDirections.actionMemoListFragmentToMemoDetailFragment()
			action.memoId = memoId
